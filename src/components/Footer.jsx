...
const Footer = ({theme}) => {
  return (
    ...
    px-4 sm:px-10 lg:px24 xl:px-40'>
          ...
          <div className='flex justify-between items-center max-lg:flex-col gap-10'>
              <motion.div
                  ...
                  <p className='-max-w-md'>From strategy to exectution, we craft digital
                      solutions that move your business forwrad.</p>

                  <ul className='flex gap-8'>
                      <li><a href="#hero" className='hover:text-primary'>Home</a></li>
                      <li><a href="#services" className='hover:text-primary'>Services</a>
                      </li>
                      <li><a href="#our-work" className='hover:text-primary'>Our work</a>
                      </li>
                      <li><a href="#contact-us" className='hover:text-primary'>Contact us</a>
                      </li>
                  </ul>
              </motion.div>
